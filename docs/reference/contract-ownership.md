...
durable Fake-only workspace foundation. Entries marked "planned runtime contract" or a
...
| [Reliability protocol](reliability-protocol.md) | Current Manual-loop/dispatcher/workspace/product-facade and planned later-runtime contract | Implemented claim semantic identity, attempts, leases, fencing, idempotency, intent/observation/receipt/finalization, Manual and Fake-workspace recovery/retry/CAS, dispatcher fan-out outcomes, and typed product derivation; external publication remains planned |
...
| [Completion and workspace contract](completion-workspace-contract.md) | Current durable-workspace and planned physical-workspace/completion contract | Implemented isolated generation identity/status/recovery; planned real worktree ownership, gate freshness, integration reservation, Git partial success, path safety, and cleanup eligibility |
