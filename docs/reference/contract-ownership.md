...
| [Versioning and compatibility contract](versioning-compatibility-contract.md) | Current schema/API/port-version owner and planned product compatibility contract | Current schema-version-1 identity and closed `ato.api/v1`/`ato.api/v2`/`ato.execution/v1`; future evolution; explicit compatibility evidence; restore boundaries; and evidence-bound support claims |
