...
const CURRENT_TABLES = Object.freeze([
  ...
  "completion_gate_finalizations",
  "completion_gate_intents",
  "completion_gate_observations",
  "completion_gate_requests",
  "completion_gate_verified_receipts",
  "dispatcher_audit",
  ...
  "integration_authorization_decisions",
  "integration_events",
  "integration_finalizations",
  "integration_intents",
  "integration_observations",
  "integration_operation_requests",
  "integration_reservations",
  "integration_target_sequences",
  "integration_verified_receipts",
  ...
  "workspace_cleanup_attestations",
  "workspace_events",
...
const CURRENT_TRIGGERS = Object.freeze([
  ...
  "completion_gate_authorization_decisions_no_update",
  "completion_gate_events_no_delete",
  "completion_gate_events_no_update",
  "completion_gate_finalizations_no_delete",
  "completion_gate_finalizations_no_update",
  "completion_gate_intents_no_delete",
  "completion_gate_intents_update_guard",
  "completion_gate_observations_no_delete",
  "completion_gate_observations_no_update",
  "completion_gate_requests_no_delete",
  "completion_gate_requests_no_update",
  "completion_gate_verified_receipts_no_delete",
  "completion_gate_verified_receipts_no_update",
  ...
  "integration_authorization_decisions_no_delete",
  "integration_authorization_decisions_no_update",
  "integration_events_no_delete",
  "integration_events_no_update",
  "integration_finalizations_no_delete",
  "integration_finalizations_no_update",
  "integration_intent_authorization_insert_guard",
  "integration_intent_authorization_update_guard",
  "integration_intents_no_delete",
  "integration_intents_update_guard",
  "integration_observations_no_delete",
  "integration_observations_no_update",
  "integration_operation_requests_no_delete",
  "integration_operation_requests_no_update",
  "integration_reservations_no_delete",
  "integration_reservations_terminal_intent_guard",
  "integration_reservations_update_guard",
  "integration_target_sequences_increment_only",
  "integration_target_sequences_no_delete",
  "integration_verified_receipts_no_delete",
  "integration_verified_receipts_no_update",
  ...
  "manual_completion_decisions_insert_guard",
  "manual_completion_decisions_no_delete",
  "manual_completion_decisions_no_update",
  "policy_gated_completion_decisions_insert_guard",
  "policy_gated_completion_decisions_no_delete",
  "policy_gated_completion_decisions_no_update",
  ...
  "workspace_cleanup_attestations_insert_guard",
  "workspace_cleanup_attestations_no_delete",
  "workspace_cleanup_attestations_no_update",
